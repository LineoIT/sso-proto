...
const (
	...
	AccountService_UpdateFullname_FullMethodName      = "/proto.AccountService/UpdateFullname"
	AccountService_EnableAccount_FullMethodName       = "/proto.AccountService/EnableAccount"
	...
	AccountService_Signin_FullMethodName              = "/proto.AccountService/Signin"
	AccountService_ForgotPassword_FullMethodName      = "/proto.AccountService/ForgotPassword"
	AccountService_EnableResetPassword_FullMethodName = "/proto.AccountService/EnableResetPassword"
	AccountService_ResetPassword_FullMethodName       = "/proto.AccountService/ResetPassword"
)
...
type AccountServiceClient interface {
	...
	UpdateFullname(ctx context.Context, in *UpdateFullnameRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *accountServiceClient) UpdateFullname(ctx context.Context, in *UpdateFullnameRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AccountService_UpdateFullname_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) EnableAccount(ctx context.Context, in *EnableAccountRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AccountService_EnableAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) ForgotPassword(ctx context.Context, in *ForgotPasswordRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AccountService_ForgotPassword_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) EnableResetPassword(ctx context.Context, in *EnableResetPasswordRequest, opts ...grpc.CallOption) (*AccessToken, error) {
	out := new(AccessToken)
	err := c.cc.Invoke(ctx, AccountService_EnableResetPassword_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServiceServer interface {
	...
	UpdateFullname(context.Context, *UpdateFullnameRequest) (*emptypb.Empty, error)
...
func (UnimplementedAccountServiceServer) UpdateFullname(context.Context, *UpdateFullnameRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateFullname not implemented")
}
func (UnimplementedAccountServiceServer) EnableAccount(context.Context, *EnableAccountRequest) (*emptypb.Empty, error) {
...
func (UnimplementedAccountServiceServer) ForgotPassword(context.Context, *ForgotPasswordRequest) (*emptypb.Empty, error) {
...
func _AccountService_UpdateFullname_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountService_UpdateFullname_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccountService_EnableResetPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountService_EnableResetPassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
