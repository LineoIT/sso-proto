...
const (
	AuditService_CreateAuditLog_FullMethodName = "/proto.AuditService/CreateAuditLog"
	AuditService_UpdateAuditLog_FullMethodName = "/proto.AuditService/UpdateAuditLog"
	AuditService_ListAuditLog_FullMethodName   = "/proto.AuditService/ListAuditLog"
	AuditService_GetAuditLog_FullMethodName    = "/proto.AuditService/GetAuditLog"
)
...
type AuditServiceClient interface {
	CreateAuditLog(ctx context.Context, in *AuditLog, opts ...grpc.CallOption) (*CreateAuditLogResponse, error)
	UpdateAuditLog(ctx context.Context, in *AuditLog, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *auditServiceClient) CreateAuditLog(ctx context.Context, in *AuditLog, opts ...grpc.CallOption) (*CreateAuditLogResponse, error) {
...
func (c *auditServiceClient) UpdateAuditLog(ctx context.Context, in *AuditLog, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AuditService_UpdateAuditLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *auditServiceClient) ListAuditLog(ctx context.Context, in *AuditLogFilter, opts ...grpc.CallOption) (*AuditLogResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuditService_ListAuditLog_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuditServiceServer interface {
	CreateAuditLog(context.Context, *AuditLog) (*CreateAuditLogResponse, error)
	UpdateAuditLog(context.Context, *AuditLog) (*emptypb.Empty, error)
...
func (UnimplementedAuditServiceServer) CreateAuditLog(context.Context, *AuditLog) (*CreateAuditLogResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAuditLog not implemented")
}
func (UnimplementedAuditServiceServer) UpdateAuditLog(context.Context, *AuditLog) (*emptypb.Empty, error) {
